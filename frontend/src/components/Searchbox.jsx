...
const Searchbox = ({setOriginCoordinates, setDestinationCoordinates, setSearchTriggered}) => {
  ...
  return (
    <div className="flex flex-col items-start p-6 space-y-6 bg-gray-100 shadow-lg max-w-xl w-full mx-auto fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 rounded-xl">
